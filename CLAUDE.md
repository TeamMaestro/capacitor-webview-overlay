...
This is **@teammaestro/capacitor-webview-overlay** - a Capacitor plugin that provides webview overlay functionality for mobile applications. The plugin allows positioning webviews over specific HTML elements with precise control.
...
- `android/src/main/java/com/teammaestro/capacitor/webviewoverlay/` - Android native code
